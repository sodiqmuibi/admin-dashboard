    ...
    <div className="nav-item absolute right-5 md:right-40 top-16 bg-gray-200 dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        <div className="flex gap-3">
          ...
          <button type="button" className="text-white text-xs rounded p-1 px-2 bg-orange-600 "> 5 New</button>
        </div>
        <button 
            type='button'
      ...
      <div className="mt-5 ">
        ...
        <div className="mt-5">
          <Button color="white" bgColor={currentColor} text="See all notifications" borderRadius="10px" size="md" />
        </div>
      </div>
    </div>
  );
